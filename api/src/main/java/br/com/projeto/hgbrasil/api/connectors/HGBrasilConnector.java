...
public class HGBrasilConnector {
    ...
    public HGBrasilResponse fetchWeatherForCity(String city_name) {

        log.info("Consultando a API da HG Brasil pra a cidade {}",city_name);

        HttpEntity<?> entity = createHeaders();

        var uriComponentsBuilder = createUriBuilder(city_name);
    ...
    private UriComponentsBuilder createUriBuilder(String city_name) {
